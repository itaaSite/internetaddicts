...
const data = {
  title: "Даниил",
  description:
    "Моя история начинается с момента, когда я маленьким мальчиком смотрел по телевизору мультфильмы и детские передачи, я очень любил проводить свое свободное время у экрана.",
};
const _internal = {
  type: "content",
  filePath: "/Users/samgold/Desktop/Проекты/itaa/src/content/story/daniil.mdoc",
  rawData:
    "\ntitle: Даниил\ndescription: >-\n  Моя история начинается с момента, когда я маленьким мальчиком смотрел по\n  телевизору мультфильмы и детские передачи, я очень любил проводить свое\n  свободное время у экрана.",
};
