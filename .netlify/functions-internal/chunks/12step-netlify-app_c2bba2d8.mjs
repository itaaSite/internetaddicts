const id = "12step-netlify-app.mdoc";
const collection = "posts";
const slug = "12step-netlify-app";
const body =
...
const _internal = {
  ...
  rawData:
    "\ntitle: 'Изучение БКАА с Джо и Чарли'\ndescription: 'На сегодняшний день, материалы Джо и Чарли являются самыми известными и используемыми в мире материалами по Большой книге.'\n\npubDate: '05.01.2023'\nimg: 'https://i.imgur.com/y3YOQC4.png'",
};
