...
function getHeadings() {
  return [
    { depth: 2, slug: "упражнение", text: "Упражнение." },
    { depth: 2, slug: "живые-группы", text: "Живые группы." },
    { depth: 2, slug: "спать", text: "Спать." },
    {
      depth: 2,
      slug: "хобби-живые-увлечения-и-занятия",
      text: "Хобби, живые увлечения и занятия.",
    },
  ];
}
